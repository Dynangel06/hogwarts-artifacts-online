...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
      return this.userRepository.findByUsername(username)// Find this user from database
                .map(hogwartsUser -> new MyUserPrincipal(hogwartsUser))// if found, wrap returned user instance in a MyUserPrincipal instance
